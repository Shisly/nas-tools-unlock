...
如果你访问github的网络不太好，可以考虑在创建容器时增加设置一个环境变量`-e REPO_URL="https://ghproxy.com/https://github.com/Shisly/nas-tools-unlock.git" \`。
...
services:
  nas-tools:
    ...
    environment: 
     ...
     #- REPO_URL=https://ghproxy.com/https://github.com/Shisly/nas-tools-unlock.git  # 当你访问github网络很差时，可以考虑解释本行注释
    restart: always
    network_mode: bridge
    hostname: nas-tools
